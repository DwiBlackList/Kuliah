...
$sql = "INSERT INTO data_buku(kode_buku, judul_buku, kode_pengarang, kode_jenis_buku, kode_penerbit, isbn, tahun, deskripsi, jumlah)
        VALUES(:kode_buku,:judul_buku,:kode_pengarang,:kode_jenis_buku,:kode_penerbit,:isbn, :tahun, :deskripsi, :jumlah)";
